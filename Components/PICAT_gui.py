...
class Ui_PICAT_SM(object):
    ...
    def retranslateUi(self, PICAT_SM):
        ...
        self.actionImport_from_Excel.setText(_translate("PICAT_SM", "Import from Excel"))
        self.actionImport_from_Excel.setShortcut(_translate("PICAT_SM", "Ctrl+I"))
        self.actionExport_to_Excel.setText(_translate("PICAT_SM", "Export to Excel"))
        self.actionExport_to_Excel.setShortcut(_translate("PICAT_SM", "Ctrl+E"))
        self.customimportexport.setText(_translate("PICAT_SM", "Custom Import/Export"))
        ...
        self.actionAdd_tabto.setText(_translate("PICAT_SM", "Add Tabto"))
        self.actionAbout.setText(_translate("PICAT_SM", "About"))
        self.actionCopy.setText(_translate("PICAT_SM", "Copy File"))
        self.sht2tbl.setText(_translate("PICAT_SM", "add sht2tbl"))

        self.actionCopy_folder.setText(_translate("PICAT_SM", "Copy Folder"))

        self.actionTab.setText(_translate("PICAT_SM", "Add Tab"))
        self.actionAdd_Folder.setText(_translate("PICAT_SM", "Add Folder"))
        
        self.actionTab_Move.setText(_translate("PICAT_SM", "Move Tab -> Form"))
        self.actionTab_Copy.setText(_translate("PICAT_SM", "Copy Tab -> Form"))
        ...
        self.actionAdd_Proc.setText(_translate("PICAT_SM", "Add New Button"))

        self.actionAdd_Desc.setText(_translate("PICAT_SM", "Add Description"))

        self.actionEdit_layout.setText(_translate("PICAT_SM", "Edit Layout"))
