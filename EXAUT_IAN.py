...
if not file_cfg:
    ...
    #pop up with ctypes
    ctypes.windll.user32.MessageBoxW(0,"No [{}] header in config.ini, please check file name and capitalization within config.ini".format(current_filename.upper()),"EXAUT Error",1)
    #exit progrm
    sys.exit()
else:
