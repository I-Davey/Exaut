version = '13 September 2022 15:08'
auth = True
...
class Authenticate:
    def __init__(self):
        ...
        if current_machine_id not in ("1E008FC0-008C-5800-5F47-3085A9A452DA", "5259A1A8-7FE8-0000-0000-000000000000", "A7859628-EF42-11E5-AA37-C4AA890DF032"):
