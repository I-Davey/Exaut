...
import time
import os,sys,ctypes,shutil,winshell
...
from Components.Popups.Create_Process import Create_Process
...
class DB_Window(QMainWindow,PICAT_gui.Ui_PICAT_SM):
    ...
    def AboutMsg(self):
        ctypes.windll.user32.MessageBoxW(0,f"Version: {version}","About ExAuT - OnInO Technologies",0)
